// Local fallback content — mirrors backend/data/*.json and
// frontend/api/_lib/content.js. Used when the API isn't reachable, so the
// site always renders correctly.
